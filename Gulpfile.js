...
gulp.task('clean:pot', function() {
	return del(['languages/atravelbroad.pot']);
});
...
gulp.task('wp-pot', ['clean:pot'], function() {
	...
	.pipe(wpPot({
		domain: 'atravelbroad',
		destFile:'atravelbroad.pot',
		package: 'atravelbroad',
		bugReport: 'http://atravelbroad.dev',
		lastTranslator: 'John Doe <mail@atravelbroad.dev>',
		team: 'Team <mail@atravelbroad.dev>'
	}))
...
gulp.task('watch', function() {
	...
	browserSync({
		...
		proxy: "atravelbroad.dev",         // Use http://atravelbroad.dev:3000 to use BrowserSync
		watchOptions: {
